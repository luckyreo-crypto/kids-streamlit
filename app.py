...
# --- 1. 기본 설정 및 스타일 ---
st.set_page_config(page_title="유년부 통합 관리 v27.0", page_icon="🌱", layout="wide")
        ...
        for c_name, group in sorted(grouped):
            ...
            for i, (idx, row) in enumerate(group.iterrows()):
                with cols[i % 3]:
                    ...
                    new_att[row['sheet_row']] = st.checkbox(row['이름'], value=is_on, key=f"att_{row['sheet_row']}")
